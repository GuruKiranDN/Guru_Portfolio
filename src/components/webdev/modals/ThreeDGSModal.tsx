...
import '../../../styles/webdev/ThreeDGSModal.css';

interface ThreeDGSModalProps {
  webDevId: string;
  onClose: () => void;
}

const ThreeDGSModal: React.FC<ThreeDGSModalProps> = ({ webDevId, onClose }) => {
        ...
        <div className="webdev-modal-content">
          ...
          <div id="webdev-materials" className="webdev-section">
            ...
            <div className="section-content materials-content">
              {typeof project.mediumsMaterials === 'string' 
                ? <p>{project.mediumsMaterials}</p>
                : project.mediumsMaterials.map((material, index) => (
