...
import '../../../styles/research/SmartDeviceCognitionModal.css';

interface SmartDeviceCognitionModalProps {
  researchId: string;
  onClose: () => void;
}

const SmartDeviceCognitionModal: React.FC<SmartDeviceCognitionModalProps> = ({ researchId, onClose }) => {
...
export default SmartDeviceCognitionModal;
